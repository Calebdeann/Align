-- =============================================
-- MIGRATION 056: Fix get_friends_with_activity column reference
-- =============================================
-- Migrations 037/041/043 all referenced ws.weight_kg, but the actual column
-- on workout_sets is ws.weight (always stored in kg). This caused every
-- friends-feed call to fail with "column ws.weight_kg does not exist" and
-- friend volumes to silently be 0. This migration drops and recreates the
-- function with the correct column name. Return shape unchanged.
