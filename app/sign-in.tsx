...
export default function SignInScreen() {
  ...
  const ensureProfileOrAlert = async (userId: string): Promise<boolean> => {
    ...
    Alert.alert(
      'No account found',
      'No It Girl account is linked to this login. Tap back to set one up.'
    );
    return false;
  };
    ...
    <View style={styles.container}>
      ...
      <SafeAreaView edges={['top']} style={styles.topArea}>
        ...
        <Text style={styles.title}>
          {'Sign '}
          <Text style={styles.titleItalic}>in</Text>
        </Text>
      </SafeAreaView>
